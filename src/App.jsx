...
/* ─────────────────────────────────────────
   APP DOWNLOAD BANNER  — dismissable, all pages
───────────────────────────────────────── */
const APP_STORE_URL = "https://apps.apple.com/us/app/gmn-news/id6746731356";

function AppBanner() {
  const [visible, setVisible] = useState(() => {
    try { return localStorage.getItem("gmn_app_banner_dismissed") !== "true"; }
    catch { return true; }
  });
  const { pathname } = useLocation();

  // Don't show on homepage — it has the full promo section
  if (!visible || pathname === "/") return null;

  function dismiss() {
    try { localStorage.setItem("gmn_app_banner_dismissed", "true"); } catch {}
    setVisible(false);
  }
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <span style={{ color: "#edf0f6", fontSize: 13, fontWeight: 600 }}>
          GMN News is now on iOS!
        </span>
        <span style={{ color: "#7a8599", fontSize: 12, display: "none" }}>—</span>
        <a
          href={APP_STORE_URL}
          target="_blank"
      ...
      <button
        ...
        style={{
          ...
          color: "#7a8599", fontSize: 20, cursor: "pointer",
  ...
  return (
    <div className="home">
      ...
      <div style={{ maxWidth: 1280, margin: "28px auto 0", padding: "0 20px" }}>
        <div style={{
          background: "linear-gradient(135deg, #111318 0%, #161a21 100%)",
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            <div style={{ fontSize: 11, fontWeight: 800, color: "#ff3232", letterSpacing: "1.2px", marginBottom: 6 }}>
              NOW ON IOS — FREE
            </div>
            <h2 style={{
              fontFamily: "var(--font-display)", fontSize: "clamp(24px,4vw,36px)",
              fontWeight: 900, textTransform: "uppercase",
              color: "#edf0f6", margin: "0 0 8px", lineHeight: 1.1,
            }}>
              GMN News<br />in your pocket
            </h2>
            <p style={{ fontSize: 13, color: "#a0aabb", margin: "0 0 18px", lineHeight: 1.6 }}>
              Live Hot 50 chart, GMN scores, community reviews and breaking gaming news — all on iOS.
            </p>
            <a
              href="https://apps.apple.com/us/app/gmn-news/id6746731356"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: "inline-flex", alignItems: "center", gap: 10,
                background: "#000", border: "1px solid rgba(255,255,255,0.2)",
                borderRadius: 12, padding: "10px 20px", textDecoration: "none",
              }}
            ...
            >
              ...
              <div>
                <div style={{ color: "#999", fontSize: 9, lineHeight: 1 }}>Download on the</div>
